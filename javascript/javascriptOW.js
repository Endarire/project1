var vidIdNum;
var searchString = 'overwatch world cup 2017 final'
...
database.ref("/commentsOW").on("value", function (snapshot) {
...
$("#submit-comment").on("click", function () {
    ...
    if (userName === "" || userComment === "") {
        ...
        database.ref("/commentsOW/com").on('value', function (snap) { commentList = snap.val(); });
        database.ref("/commentsOW/users").on('value', function (snap) { userList = snap.val(); });
        ...
        database.ref("/commentsOW/com").set(commentList);
        database.ref("/commentsOW/users").set(userList);
